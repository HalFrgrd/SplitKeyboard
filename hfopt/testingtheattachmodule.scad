...
c1 = [ [0,0,size[2]/2],  [-1,0,0],     0 ];  //-- Top connector
...
translate([10,10,10]) cube(size,center=true);
...
//-- Connector
//--    att. point                 att. axis  roll
a = [ [0, asize[1]/2-3,-asize[2]/2], [0,1,0],   0  ];

//-- Draw the attachable part apart
translate([40,0,0]) arm(debug);

//------- Attach the parts! -------
translate([10,10,10]) attach(c1,a) arm(debug);
