...
#define MANUFACTURER    HFrgrd
#define PRODUCT         hfvoy
#define DESCRIPTION     A split keyboard, interlocking, 85%
...
// #define MATRIX_COL_PINS { D4, C6, D7, E6, B4, B5, B6, B2, B3 } //rightside flipped =bad
